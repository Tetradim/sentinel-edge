"""Install the enhanced-analysis Prometheus metrics missing from legacy metrics.py."""
...
def _install(name: str, factory) -> None:
    if not hasattr(edge_metrics, name):
        setattr(edge_metrics, name, factory())
