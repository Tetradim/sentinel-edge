...
class ScannerWorkbenchStaticTests(unittest.TestCase):
    ...
    def test_frontend_api_and_types_include_scanner_workbench_contract(self):
        ...
        self.assertIn("expanded_counts", types)
        self.assertIn("expanded_intent", types)
    ...
    def test_scanner_workbench_ui_has_watch_tabs_and_no_collection_tab(self):
        ...
        self.assertIn("validation.expanded_intent", dashboard)
        self.assertIn("validation.expanded_counts", dashboard)
        self.assertIn("formatExpandedWatchPlan", dashboard)
        self.assertIn("Expanded plan", dashboard)
        self.assertIn("validation.expanded_counts.scanners", dashboard)
        self.assertIn("applyStrategyKit", dashboard)
        self.assertIn("Add strategy kit", dashboard)
        self.assertIn("...strategy.scanner_ids", dashboard)
        self.assertIn("...strategy.indicator_ids", dashboard)
