...
- Buying-power allocation experiments through `/api/simulation-lab/buying-power/allocation`, including requested demand, unfilled demand, aggregate fill-ratio summaries, and position-cap constraint attribution.
...
| POST | `/simulation-lab/buying-power/allocation` | Compare gated buying-power allocation plans for candidate trades with requested, unfilled, fill-ratio, and position-limit summaries. |
...
3. Simulation Lab foundation
   ...
   - buying-power allocation experiments with demand-fill and position-limit summaries
